...
export default function SignupPage() {
  ...
  return (
    <div className="bg-warm-white rounded-2xl shadow-sm border border-cream-dark p-8">
      <h2 className="text-lg font-semibold text-soft-black mb-2">Create your account</h2>
      <p className="text-sm text-warm-gray mb-6">
        Start remembering what the people you love mention.
      </p>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2.5 border border-cream-dark rounded-lg text-sm font-medium text-warm-gray hover:bg-cream transition-colors mb-4"
      >
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-warm-white px-3 text-warm-gray-light">or</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-warm-gray mb-1">
            Password
          </label>
          <input
            id="password"
