...
export default function LoginPage() {
  ...
  return (
    <div className="bg-warm-white rounded-2xl shadow-sm border border-cream-dark p-8">
      <h2 className="text-lg font-semibold text-soft-black mb-6">Welcome back</h2>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2.5 border border-cream-dark rounded-lg text-sm font-medium text-warm-gray hover:bg-cream transition-colors"
      >
      ...
      <div className="mt-6 text-center text-sm text-warm-gray">
        <Link href="/forgot-password" className="text-coral hover:underline">
          Forgot password?
        </Link>
